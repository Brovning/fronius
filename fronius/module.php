						...
						if(DEVICE_WR == $deviceType)
						{
							$inverterModelRegister_array = array(
								...
								*/
								...
								//array(40225, 2, "R", "0x03", "StSetLimMsk", "Bit Mask indicating setpoint limit(s) reached. Bits are persistent and must be cleared by the controller.", "uint32", "Bitfield", "Not supported"),
								array(40227, 2, "R", "0x03", "StActCtl - inverter controls", "Bit Mask indicating which inverter controls are currently active. / Bitfeld für zurzeit aktive Wechselrichter-Modi: Bit 0: Leistungsreduktion (FixedW; entspricht WMaxLimPct Vorgabe), Bit 1: konstante Blindleistungs-Vorgabe (FixedVAR; entspricht VArMaxPct), Bit 2: Vorgabe eines konstanten Power Factors (FixedPF; entspricht OutPFSet)", "uint32", "Bitfield", "Bit 0: FixedW, Bit 1: FixedVAR, Bit 2: FixedPF"),
					...
					if ($readI160)
					{
						if(DEVICE_WR == $deviceType)
						{
							$inverterModelRegister_array = array(
								...
								array(40270, 2, "R", "0x03", "Evt", "Global Events", "uint32", "Bitfield", ""),
								...
								array(40292, 2, "R", "0x03", "1_DCEvt", "Module Events", "uint32", "Bitfield", ""),
